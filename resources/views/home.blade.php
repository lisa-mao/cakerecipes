...
<div class="flex pl-6 justify-center m-20 flex-col justify-center">
    ...
    <div class="flex justify-row justify-center  ">
        @foreach($categories as $category)
            ...
            <input type="checkbox" value="{{$category->name}}" name="category[]" id="{{$category->name}}" class="hidden">
            <label for="{{$category->name}}" class="category-button m-1">{{$category->name}}</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-7xl mx-auto ">
        ...
        <a href="/recipes/{{ $recipe['id'] }}" class="block group transform transition duration-300 ease-in-out hover:shadow-2xl hover:scale-[1.03] focus:outline-none focus:ring-4 focus:ring-[#6D94C5] rounded-xl overflow-hidden shadow-lg bg-white h-full">
            ...
            <div class="p-6 h-full flex flex-col ">
                ...
                <div class="flex justify-between items-start mb-2">
                    ...
                    <div class="flex-shrink-0 bg-[#6D94C5] text-white text-xs font-semibold px-3 py-1 rounded-full shadow-md mt-1">
                ...
                <div class="flex justify-between items-center text-sm text-gray-500 border-t pt-4 mt-auto">
                    ...
                    <div class="flex items-center space-x-2">
                        <!-- Time Icon (using SVG) -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#6D94C5]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
