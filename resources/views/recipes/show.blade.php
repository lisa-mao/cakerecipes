                    ...
                    @if (Auth::user()->id === $recipe->user_id)
                        <div class="mt-4 flex space-x-3">
                            ...
                            <a href="/recipes/{{ $recipe->id }}/edit"
                               class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#6D94C5] hover:bg-[#6D94C5] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150">
                            ...
                            <form method="POST" action="/recipes/{{ $recipe->id }}">
                                ...
                                @method('DELETE')
                                <button type="submit"
                                        class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#6D94C5] hover:bg-[#6D94C5] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition duration-150">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div
                ...
                <div class="flex items-center space-x-3 text-[#6D94C5]">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold">{{ $recipe->total_time }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-3 text-[#6D94C5]">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold">{{ $recipe->prep_time }}</p>
                    </div>
                </div>
